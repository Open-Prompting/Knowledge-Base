...
Нейросеть может не знать роль, которую должна исполнить. Так, ЧатГПТ обучался преимущественно на английских текстах, поэтому знает англоязычных редакторами, а не российских — не всегда:

...
Нейросеть может не знать роль, которую должна исполнить. Так, ЧатГПТ обучался преимущественно на английских текстах, поэтому лучше знаком с англоязычными редакторами, а не российскими:

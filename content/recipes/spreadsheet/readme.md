...
4. Ввести в&nbsp;настройках расширения ключ АПИ. Выбрать в&nbsp;меню гугль-таблица пункт &laquo;Расширения&raquo; и&nbsp;открыть GPT for Sheets and Docs. Там найти пункт Set API key и&nbsp;ввести в&nbsp;него ключ OpenAI.

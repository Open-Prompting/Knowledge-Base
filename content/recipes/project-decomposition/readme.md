...
<img src="https://github.com/Open-Prompting/Knowledge-Base/blob/main/content/recipes/debug-server/media/screenshot-project-decomposition-dark.png#gh-dark-mode-only" width="70%" height="70%">

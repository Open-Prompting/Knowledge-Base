![cover](https://github.com/Open-Prompting/Knowledge-Base/blob/main/content/recipes/draft-plan/media/cover-draft-light.svg#gh-light-mode-only)
...
Допустим, вы готовите контент-план для корпоративного блога в новой для вас области. Для этого выясняют, о чём в блогах пишут конкуренты. Нейросеть быстрее человека проанализирует большие объёмы информации. Попросите ЧатГПТ сделать черновик контент-плана.
...
## Как сделать
1. Описать клиента: особенность бизнеса, целевую аудиторию.
2. Описать контент-план: как часто и как долго будут выходить статьи.
...
<img src="media/plan-light.png#gh-light-mode-only" width="70%" height="70%">
<img src="media/plan-dark.png#gh-dark-mode-only" width="70%" height="70%">


## Что может пойти не так
ЧатГПТ может генерировать слишком общие или слишком частные темы. Если не устраивает большая часть предложенного плана, переформулируйте промт. Или попросите ЧатГПТ сгенерировать больше вариантов и выберите из наиболее подходящие.

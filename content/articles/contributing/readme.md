...
1. Вы пишете черновик рецепта, добавляете иллюстрации, следуя данному руководству.
2. Присылаете рецепт нам, оформляя его как пулл-реквест.
3. Мы проверяем, что рецепт работает.
4. Редактируем рецепт, чтобы он следовал нашим гайдам.
5. Публикуем рецепт.
...
Имя файла с обложкой должно иметь вид `cover-keyword.png`. Ключевое слово `keyword`  должно остылать к главному в рецепте. Например, если рецепт про заполнение таблицы ключевым словом может быть `table`. 
...
3. Сохраните файл со скришотом. Имя файла должно иметь вид `screenshot-keyword.png`. Ключевым слово оставьте таким же, как у файла с обложкой.
...
Ещё быстрее мы опубликуем рецепт, если подготовите два скриншота: на светлой и тёмной теме. Без этого читателям с темной темой Гитхаба будет сложнее прочитать рецепт со светлым скриншотом, и наоборот.

Пиложите два скриншота и измените ссылку в черновике. После основного урла картинки добавьте:
...
Согласно [лицензионному соглашению](https://github.com/Open-Prompting/Knowledge-Base/blob/main/licence.md), публикуя рецепт или статью, вы передаете авторские права на него и входящие в него материалы Ресурсу, чтобы модераторы Ресурса могли вносить в него редакторские правки, а другие участники могли дополнять его.

...
## Стиль текста
1. Пишем кратко. Краткость проверяем [в сервисе «Главред»](https://glvrd.ru/). Тексты Open Promting набирают там не менее 8 баллов.
...
6. Пишем кириллицей названия нейросетей, компаний и расхожие технические термины в статьях, например: ЧатГПТ, ОпенАИ, Гугль-таблицы. Для редко упоминаемых продуктов сохраняем оригинальное написание: GPT For Sheets and Docs, GPT Mate.

...
Например, чтобы получить картину в стиле Рембрандта, не обязательно подробно описывать насыщенность цвета и характер теней. Достаточно попросить нейросеть представить себя Рембрандтом. Такой приём называют «ролевой промт».

Мы готовим описание следующих приемов:

Первый раздел будет посвящен классическим приеёмам написания промптов: 
— простой промт,  
— ролевой промт,  
— промт с инструкцией,  
— промт с образцом,   

...
База знаний может:
 ...
 4.1  Вносить изменения в произведения, предоставленные пользователями;
 
 4.2  Создавать на базе опубликованных произведений производные произведения;
 
 4.3  Использовать все произведения, опубликованные в базе знаний, для коммерческой деятельности.Использовать все произведения, опубликованные в базе знаний, для коммерческой деятельности.Использовать все произведения, опубликованные в базе знаний, для коммерческой деятельности.Использовать все произведения, опубликованные в базе знаний, для коммерческой деятельности.
